  ...
  return (
    <>
            ...
            <div className="flex w-full items-center justify-evenly bg-white">
              <button
                ...
                className={cn(
                  ...
                  "w-full px-4 py-3 transition-colors duration-200 font-medium cursor-pointer"
                )}
              >
                Ship
              </button>
              <button
                onClick={() => handleDeliveryType("shop")}
                className={cn(
                  deliveryType === "shop"
                    ? "bg-primary text-white"
                    : "hover:bg-gray-100 text-secondary",
              ...
              <button
                onClick={() => handleDeliveryType("track")}
                className={cn(
                  deliveryType === "track"
                    ? "bg-primary text-white"
                    : "hover:bg-gray-100 text-secondary",
      ...
      <div className="container mx-auto py-12 text-center">
        ...
        <p className="text-lg">
          Easily send and receive packages through our trusted access points.
        </p>
    ...
    <>
      <form ref={form} onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <button
          type="submit"
          disabled={isPending}
          className="bg-primary hover:bg-[#e0851d] text-white w-full px-4 py-3 cursor-pointer rounded-lg font-bold shadow-lg transition-all transform hover:scale-[1.02] mt-2 disabled:opacity-50"
        >
  ...
  return (
    <div className="flex flex-col gap-4 items-center justify-center">
      ...
      {trackData.map((item) => (
        <div
          key={item.id}
          className="bg-white py-2 rounded-xl flex items-center justify-around gap-2 w-full"
        >
          <Image
            src={item.image}
            alt={item.name}
