...
import { FaShoppingCart, FaArrowLeft, FaMinus, FaPlus, FaCheck } from 'react-icons/fa'
...
export default function ProductDetailsPage({ params }) {
  ...
  // Mock sizes based on category (could be in data)
  ...
  return (
    <div className="min-h-screen bg-white py-12">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {/* Back Button */}
        <Link href="/products" className="inline-flex items-center text-gray-500 hover:text-primary mb-8 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col">
            <span className="text-sm text-gray-500 font-medium mb-2">{product.category}</span>
            ...
            {/* Size Selection */}
            <div className="mb-8">
              <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wide mb-4">Select Size</h3>
