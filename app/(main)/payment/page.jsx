...
export default function Payment() {
  return (
    <section className='container mx-auto py-12 px-4'>
        <h1 className='text-3xl font-bold mb-8 text-gray-800'>USA Bank Details</h1>
        ...
        <div className='bg-white shadow-sm border border-gray-100 rounded-lg p-8 mb-8 flex flex-col md:flex-row items-center md:items-start gap-8'>
            ...
            <div className='w-full md:w-2/3 space-y-2 text-gray-700'>
                ...
                <p><span className='font-semibold'>BANK NAME:</span> CITI BANK</p>
                <p><span className='font-semibold'>Account name :</span> Tic Innovative Inc</p>
                <p><span className='font-semibold'>Account number:</span> 6879224714</p>
                <p><span className='font-semibold'>Routing Number:</span> 021000089</p>
                <p><span className='font-semibold'>Address.</span> 184-04 Hillside Avenue ,Jamaica, Ny,11432</p>
            </div>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <div className='bg-white shadow-sm border border-gray-100 rounded-lg p-6 flex items-center gap-4'>
                ...
                <div>
                    ...
                    <p className='text-gray-600'>azharflex5@gmail.com</p>
                </div>
            </div>
            ...
            <div className='bg-white shadow-sm border border-gray-100 rounded-lg p-6 flex items-center gap-4'>
                ...
                <div>
                    ...
                    <p className='text-gray-600'>accounts@ticonsultancy.co.uk</p>
                </div>
            </div>
            ...
            <div className='bg-white shadow-sm border border-gray-100 rounded-lg p-6 flex items-center gap-4'>
                ...
                <div>
                    ...
                    <p className='text-gray-600'>ticinnovative69@gmail.com</p>
                </div>
            </div>
            ...
            <div className='bg-white shadow-sm border border-gray-100 rounded-lg p-6 flex items-center gap-4'>
                ...
                <div>
                    ...
                    <p className='text-gray-600'>mdazharu915@gmail.com</p>
                </div>
            </div>
        </div>
    </section>
